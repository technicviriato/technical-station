...
public sealed class PaperSystem : EntitySystem
{
    ...
    private void OnInputTextMessage(Entity<PaperComponent> entity, ref PaperInputTextMessage args)
    {
        ...
        {
            SetContent(entity, args.Text, args.Actor); // Trauma - pass user
        ...
        EntityUid? user = null) // Trauma
    {
        ...
        UpdateUserInterface(entity);
        // <Trauma>
        var ev = new PaperWrittenEvent(user, content);
    ...
    public void UpdateUserInterface(Entity<PaperComponent> entity) // Trauma - made public
    {
